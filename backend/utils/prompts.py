...
7. The Learn More Links should be an array of 3-4 different links as strings to real-world, working, and live educational resources that the user can learn more about the topic.
8. Your entire response must be **raw JSON**. Use the **exact keys** as shown to the right: {{"title": "text", "chapter1section1": "text", "chapter1quote": "text", "chapter1section2": "text", "chapter2section1": "text", "chapter2quote": "text", "chapter2section2": "text", "chapter3section1": "text", "chapter3quote": "text", "chapter3section2": "text", "summary": "text", "learnMoreLinks": ["text", "text", "text", "text"], "imagePrompt1": "text", "imagePrompt2": "text", "imagePrompt3": "text"}}
